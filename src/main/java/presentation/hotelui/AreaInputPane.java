...
public class AreaInputPane extends GridPane {
	...
	public AreaInputPane(int customerID) throws RemoteException {
		...
		AnchorPane.setLeftAnchor(chooseCity, 320.0);
		AnchorPane.setTopAnchor(cityBox, 213.0);
		AnchorPane.setLeftAnchor(cityBox, 446.0);

		AnchorPane.setTopAnchor(chooseBussin, 312.0);
		AnchorPane.setLeftAnchor(chooseBussin, 320.0);
		AnchorPane.setTopAnchor(businessCircleBox, 305.0);
		AnchorPane.setLeftAnchor(businessCircleBox, 446.0);

		AnchorPane.setTopAnchor(confirmButton, 410.0);
		AnchorPane.setLeftAnchor(confirmButton, 360.0);
		AnchorPane.setTopAnchor(backButton, 410.0);
		AnchorPane.setLeftAnchor(backButton, 490.0);
